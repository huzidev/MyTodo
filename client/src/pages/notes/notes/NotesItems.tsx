...
export default function NotesItems(): JSX.Element {
  ...
  const [isCheckedState, setIsCheckedState] = useState<boolean | undefined>(
    undefined
  );
  ...
  return (
    <div>
      ...
      <FilterList notes={allNotes} updateNote={updateNote} />
    </div>
  );
}
